    ...
    <div class="admin-content">
        ...
        <form class="am-form" action="{{ route('shop.express.update', $express->id) }}" method="post">
            ...
            <div class="am-g am-margin-top">
                ...
                <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                    <textarea rows="4" name="description">{{$express->description}}</textarea>
                </div>
            </div>
            ...
            <div class="am-g am-margin-top">
                ...
                <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                    <label class="am-radio-inline">
                        <input type="radio" value="1" name="is_enable" @if($express->is_enable == '1') checked @endif> 是
                    </label>
                    <label class="am-radio-inline">
                        <input type="radio" value="0" name="is_enable" @if($express->is_enable == '0') checked @endif> 否
                    </label>
                </div>
            </div>
