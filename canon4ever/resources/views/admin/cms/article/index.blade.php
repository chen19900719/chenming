                    ...
                    <table class="am-table am-table-striped am-table-hover table-main">
                        ...
                        @foreach ($articles as $article)
                            <tr data-id="{{$article->id}}">
                                ...
                                <td>
                                    <a href="{{$article->from_url}}" target="_blank">
                                        {{$article->from_name}}
                                    </a>
                                </td>
                                ...
                                <td>
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            ...
                                            <a class="am-btn am-btn-default am-btn-xs am-text-primary" target="_blank" href="http://{{env('HOME_DOMAIN').'/article/'. $article->id}}">
                                                <span class="am-icon-eye"></span> 查看
                                            </a>

                                            <a class="am-btn am-btn-default am-btn-xs am-text-secondary" href="{{route('cms.article.edit', $article->id)}}">
                                                <span class="am-icon-pencil-square-o"></span> 编辑
                                            </a>

                                            <a class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" href="{{route('cms.article.destroy', $article->id)}}"
