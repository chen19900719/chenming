            ...
            <div class="am-u-sm-12 am-u-md-12">
                ...
                <form class="am-form" action="{{ route('cms.article.update', $article->id) }}" method="post">
                    ...
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                            <input type="text" class="am-input-sm" name="from_name" placeholder="请填写作者姓名" value="{{$article->from_name}}">
                        </div>
                    </div>
                    ...
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                            <input type="text" class="am-input-sm" name="from_url" placeholder="请填写来源网址" value="{{$article->from_url}}">
                        </div>
                    </div>
                    ...
                    <div class="am-g am-margin-top-sm">
                        <div class="am-u-sm-12 am-u-md-12">
                            <div id="markdown">
                                <textarea rows="10" name="content" style="display:none;">{{$article->content}}</textarea>
                            </div>
                        </div>
                    </div>
