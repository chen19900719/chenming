                ...
                <div class="am-tab-panel">
                    ...
                    <form class="am-form " action="{{route('system.user.update', $user->id)}}" method="post">
                        ...
                        <div class="am-g am-margin-top">
                            ...
                            <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                                <input type="text" class="am-input-sm" name="real_name" value="{{ old('real_name') ? old('real_name') : $user->real_name}}">
                            </div>
                        </div>
                        ...
                        <div class="am-g am-margin-top">
                            ...
                            <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                                <input type="text" class="am-input-sm" name="email" value="{{ old('email') ? old('email') : $user->email}}">
                            </div>
                        </div>
                                ...
                                @foreach ($roles as $role)
                                    <label class="am-checkbox-inline">
                                        <input type="checkbox" name="role_id[]" value="{{$role->id}}"
                                               @if(old('role_id'))
                                               @if(in_array($role->id, old('role_id')))
                                               checked
                                               @endif
                                               @elseif($user_roles->contains($role->id))
                                                checked
                                                @endif
                                        >
                                        {{$role->name}}
